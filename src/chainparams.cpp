...
// Copyright (c) 2022 The Geckocoin developers
...
{
    const char* pszTimestamp = "Geckocoin was released on September 18, 2022";
    const CScript genesisOutputScript = CScript() << ParseHex("041cdbe56611322bdece2d158dde0b58cb7c0c20cb7efd0e0d24712505aab2734eade60d58eaba37408199621930665ae12fbb5f8b995a39b6d6d35d1d0cca87cc") << OP_CHECKSIG;
...
public:
    CMainParams() {
       ...
       // consensus.DIP0003EnforcementHeight = 1047200;
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Geckocoin: 1 day
        consensus.nPowTargetSpacing = 2 * 60; // Geckocoin: 2 minutes
        ...
        pchMessageStart[1] = 0xec;//t
        pchMessageStart[2] = 0xd5;//m
        pchMessageStart[3] = 0xba;//.
        nDefaultPort = 11342;
        nPruneAfterHeight = 100000;
//        FindMainNetGenesisBlock(1663523301, 0x20001fff, "main");
        genesis = CreateGenesisBlock(1663523301, 110, 0x20001fff, 4, 5000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xa90eb1c028fe12874b66bdeebdcc36116bc766d90515e0d27afa814d85cd1aca"));
        assert(genesis.hashMerkleRoot == uint256S("0x075f9eedb6ef6acb459ce3ed9849be7a4926565b730b7f0600a17c56fa30a68f"));

        vSeeds.emplace_back("start01.gecko.mn", true);
        vSeeds.emplace_back("start02.gecko.mn", true);
        vSeeds.emplace_back("start03.gecko.mn", true);


        // Geckocoin addresses start with 'r'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,38);
        // Geckocoin script addresses start with '7'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,33);
        // Geckocoin private keys start with '7' or 'X'
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,28);
        // Geckocoin BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x88, 0xB2, 0x1E};
        // Geckocoin BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x88, 0xAD, 0xE4};
        // Geckocoin BIP44 coin type is '5'
        nExtCoinType = gArgs.GetArg("-extcoinindex", 200);
        nExtCoinType = nExtCoinType == 0 ? 200 : nExtCoinType;
        vector<FounderRewardStructure> rewardStructures = {  {INT_MAX, 2}// 5% founder/dev fee forever
                                        										   };
        ...
        vSporkAddresses = {"GRND7oj2DtD5HSZNAUfb9d5GhjcF1i8PJG"};
        nMinSporkKeys = 1;
        ...
        chainTxData = ChainTxData{
        	1663523366, // * UNIX timestamp of last known number of transactions (Block 0)
...
public:
    CTestNetParams() {
     ...
     //   consensus.DIP0003EnforcementHeight = 7300;
        consensus.powLimit = uint256S("00ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"); // ~uint256(0) >> 20
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Geckocoin: 1 day
        consensus.nPowTargetSpacing = 60; // Geckocoin: 1 minutes
...
//      FindMainNetGenesisBlock(1663524649,  0x20001fff, "test");
        genesis = CreateGenesisBlock(1663524649, 4346, 0x20001fff, 4, 5000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x50a9c29bb7ed1ec686cffc29328ab227df70d41421a1e40c509f6ad3453f7fa3"));
        assert(genesis.hashMerkleRoot == uint256S("0x075f9eedb6ef6acb459ce3ed9849be7a4926565b730b7f0600a17c56fa30a68f"));
        ...
        vSeeds.emplace_back("testnet1.geckocoin.app", true);
        vSeeds.emplace_back("testnet2.geckocoin.app", true);

        // Testnet Geckocoin addresses start with 'r'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,123);
        // Testnet Geckocoin script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Testnet Geckocoin BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Testnet Geckocoin BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Testnet Geckocoin BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 10227;
        ...
        chainTxData = ChainTxData{
        	1663524649, // * UNIX timestamp of last known number of transactions (Block 213054)
            0,    // * total number of transactions between genesis and that timestamp
                        //   (the tx=... number in the SetBestChain debug.log lines)
...
public:
    CDevNetParams() {
       ...
       // consensus.DIP0003EnforcementHeight = 2; // DIP0003 activated immediately on devnet
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Geckocoin: 1 day
        consensus.nPowTargetSpacing = 2.5 * 60; // Geckocoin: 2.5 minutes
        consensus.fPowAllowMinDifficultyBlocks = true;
        consensus.fPowNoRetargeting = false;
        consensus.nPowDGWHeight = 60;
		consensus.DGWBlocksAvg = 60;
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("geckocoinevo.org",  "devnet-seed.geckocoinevo.org"));

        // Testnet Geckocoin addresses start with 'y'
...
public:
    CRegTestParams() {
       ...
       // consensus.DIP0003EnforcementHeight = 500;
        ...
        // Regtest Geckocoin addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Regtest Geckocoin script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Regtest Geckocoin BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Regtest Geckocoin BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Regtest Geckocoin BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
