...
#ifndef GECKOCOIN_ARITH_UINT256_H
#define GECKOCOIN_ARITH_UINT256_H
...
public:
     ...
     *
     * Geckocoin only uses this "compact" format for encoding difficulty
...
#endif // GECKOCOIN_ARITH_UINT256_H
