...
#error Client version information missing: version is not defined by geckocoin-config.h or in any other way
#endif
...
/**
 * geckocoind-res.rc includes this file, but it cannot cope with real c++ code.
