...
class WalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Send 210 GECKOCOIN from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 1000 GECKOCOIN in block rewards plus fees, but
        ...
        # Send 100 GECKOCOIN with subtract fee from amount
        ...
        # Sendmany 100 GECKOCOIN with subtract fee from amount
