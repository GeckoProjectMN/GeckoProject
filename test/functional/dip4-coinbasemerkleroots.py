...
from test_framework.test_framework import GeckocoinTestFramework
...
class LLMQCoinbaseCommitmentsTest(GeckocoinTestFramework):
    def set_test_params(self):
        self.set_geckocoin_test_params(6, 5, fast_dip3_enforcement=True)
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as GeckocoinTestFramework doesn't support this atm)
