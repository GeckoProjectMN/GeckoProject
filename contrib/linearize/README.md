# Linearize
Construct a linear, no-fork, best version of the Geckocoin blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install geckocoin_hash

https://github.com/geckocoin/geckocoin_hash
...
JSON-RPC server. Running `geckocoind` or `geckocoin-qt -server` will be sufficient.
...
* `input`: geckocoind blocks/ directory containing blkNNNNN.dat
