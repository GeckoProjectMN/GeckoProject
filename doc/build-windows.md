...
Below are some notes on how to build Geckocoin Core for Windows.
...
way. This will install to `c:\workspace\geckocoin`, for example:

    make install DESTDIR=/mnt/c/workspace/geckocoin
