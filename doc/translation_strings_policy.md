...
This document provides guidelines for internationalization of the Geckocoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `geckocoin_en.ts` remains unchanged.
