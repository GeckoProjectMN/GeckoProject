...
rm -rf test_bitcoin.coverage/ geckocoin-gtest.coverage/ total.coverage/
...
clean_exe src/geckocoin-cli
clean_exe src/geckocoind
clean_exe src/geckocoin-gtest
clean_exe src/geckocoin-tx
